...
object JVM_DIAGNOSTICS_LIST : DiagnosticList("FirJvmErrors") {
    ...
    val EXTERNAL_DECLARATION by object : DiagnosticGroup("External Declaration") {
        val EXTERNAL_DECLARATION_CANNOT_BE_ABSTRACT by error<KtDeclaration>(PositioningStrategy.DECLARATION_SIGNATURE) // was ABSTRACT_MODIFIER (Menta has no abstract)
