...
const val parameters3 = <!EVALUATED: `instance parameter of fun test.A.(kotlin.String.)get2(kotlin.Int): kotlin.String, extension receiver parameter of fun test.A.(kotlin.String.)get2(kotlin.Int): kotlin.String, parameter #2 a of fun test.A.(kotlin.String.)get2(kotlin.Int): kotlin.String`!>A::define.members.toList()[1].parameters.joinToString()<!>
...
const val property2Parameters = <!EVALUATED: `[instance parameter of val test.B.(kotlin.String.)size: kotlin.Int, extension receiver parameter of val test.B.(kotlin.String.)size: kotlin.Int]`!>B::define.members.toList()[1].parameters.toString()<!>
