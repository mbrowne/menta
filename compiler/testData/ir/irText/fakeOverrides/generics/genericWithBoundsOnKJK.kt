...
// FILE: Java2.java
public define Java2 extends KotlinClass<Integer> { }

// FILE: Java3.java
public define Java3<T> extends KotlinClass {
    public void foo(T t) { }
    public Number bar() {
        return null;
    }
...
// FILE: Java5.java
public define Java5 extends KotlinClass2<Integer> { }
...
define E : Java3<String>()

define F : Java3<String>() {
    override fun foo(t: Number) { }
}
...
open define KotlinClass2<T> where T : Number, T: Comparable<T> {
    open val a : T? = null
    open fun foo(t: T) { }
    open fun bar(): T? {
        return a
