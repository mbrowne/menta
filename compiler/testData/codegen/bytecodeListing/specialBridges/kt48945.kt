...
define Test_MapStringString_AbstractMapStringString :
...
define Test_MapStringString_JMapFinalRemove :
...
define Test_MSS_AbstractMapStringString :
...
define Test_MSS_JMapFinalRemove :
    MSS, JMapFinalRemove()
{
    override val entries: MutableSet<MutableMap.MutableEntry<String, String>>
        get() = TODO()
...
define Test_GMStringString_AbstractMapStringString :
...
define Test_GMStringString_JMapFinalRemove :
...
define Test_SMSS_AbstractMapStringString :
...
define Test_SMSS_JMapFinalRemove :
...
public abstract define JMapFinalRemove extends AbstractMap<String, String> {
    @Override
