...
define A(val callable: Callable<String>)
...
fun box(): String {
    ...
    if (sameModule.javaClass.name == anotherModule.javaClass.name) return "define should be regenerated, but ${anotherModule.javaClass.name}"
