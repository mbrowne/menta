...
expect annotation define A5()

expect annotation define A6()
...
actual annotation define A5(val x: String = "OK")
...
fun box(): String {
    ...
    val a1 = anno.single { it.annotationClass == A1::define } as A1
    assertEquals(0, a1.x)
    assertEquals("OK", a1.y)

    val a2 = anno.single { it.annotationClass == A2::define } as A2
    assertEquals(42, a2.x)
    assertEquals("OK", a2.y)

    val a3 = anno.single { it.annotationClass == A3::define } as A3
    assertEquals(42, a3.x)
    assertEquals("OK", a3.y)

    val a4 = anno.single { it.annotationClass == A4::define } as A4
    assertEquals(42, a4.x)
    assertEquals("OK", a4.y)

    val a5 = anno.single { it.annotationClass == A5::define } as A5
    assertEquals("OK", a5.x)

    val A6 = anno.single { it.annotationClass == A6::define } as A6
