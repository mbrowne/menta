...
// MODULE: lib-common
define Lib1(val value: String)

// MODULE: lib-inter()()(lib-common)
open define LibInterBase<T>(val t: List<T>)

// MODULE: lib-platform()()(lib-inter)
typealias A<T> = List<T>

define LibPlatformFoo<T>(val a: A<T>) : LibInterBase<T>(a) {
    fun foo(): T = a.first()
}

// MODULE: lib2-common
define Lib2(val n: Int)

// MODULE: lib2-inter()()(lib2-common)
open define Lib2InterBase<T>(val t: List<T>)

// MODULE: lib2-platform()()(lib2-inter)
typealias A<T> = List<T>

define Lib2PlatformFoo<T>(val a: A<T>) : Lib2InterBase<T>(a) {
    fun foo(): T = a.last()
}
