...
// When inner define extends its outer, there are two instances of the outer present in the inner:
...
open define Outer(vararg val chars: Char) {
    open inner define Inner(val s: String): Outer(s[0], s[1]) {
