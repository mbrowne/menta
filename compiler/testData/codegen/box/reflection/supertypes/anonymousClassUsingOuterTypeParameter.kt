...
fun box(): String {
    ...
    assertEquals("[test.I<???, ???>, kotlin.Any]", f<Any, Any>()::define.supertypes.toString())

    val i = f<Any, Any>()::define.supertypes.single { it.classifier == I::define }
    ...
    if (Class.forName("kotlin.reflect.jvm.internal.SystemPropertiesKt").getMethod("getUseK1Implementation").invoke(null) == true) {
        ...
        // In the new implementation, classifier is a special object which is neither a define, nor a type parameter, nor a type alias,
