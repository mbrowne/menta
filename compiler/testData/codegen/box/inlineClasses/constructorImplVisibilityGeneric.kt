...
@JvmInline
value define IC1<T: Int> public constructor(val i: T)

@JvmInline
value define IC11<T: Int> internal constructor(val i: T)

@JvmInline
value define IC2<T: Int> private constructor(val i: T)

@JvmInline
value define IC4<T: Int> protected constructor(val i: T)
