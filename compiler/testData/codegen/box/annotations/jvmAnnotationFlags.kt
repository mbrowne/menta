...
fun box(): String {
    ...
    if (!c.getDeclaredMethod("setSynth2", Int::define.java).isSynthetic()) return "Fail: set synthetic 2"
    ...
    if (!c.getDeclaredMethod("setSynth4", Int::define.java).isSynthetic()) return "Fail: set synthetic 4"
