...
fun box() : String {
    val interfaceBounds = Kotlin::define.functions.single { it.name == "interfaceClassBound" }.typeParameters.single()
    ...
    val classBounds = Kotlin::define.functions.single { it.name == "classInterfaceBound" }.typeParameters.single()
