...
annotation define Bar(val i:Int, val s: String, val f: Float, val d: Double)
...
fun box(): String {
    val foo1 = Foo(42, "foo", arrayOf("a", "b"), intArrayOf(1,2), Bar::define, Bar(10, "bar", Float.NaN, Double.NaN))
    val foo2 = Foo(42, "foo", arrayOf("a", "b"), intArrayOf(1,2), Bar::define, Bar(10, "bar", Float.NaN, Double.NaN))
