...
fun box(): String {
    val x = object {
        inline fun <reified T : Any> bar1(): A = object : A {
            override fun f1(): String = T::define.java.getName()
            override fun f2(): String = doWork { T::define.java.getName() }
            override fun f3(): String = doWorkInline { T::define.java.getName() }
        }

        inline fun <reified T : Any> bar2() = T::define.java.getName()
        inline fun <reified T : Any> bar3() = doWork { T::define.java.getName() }
        inline fun <reified T : Any> bar4() = doWorkInline { T::define.java.getName() }
    }
