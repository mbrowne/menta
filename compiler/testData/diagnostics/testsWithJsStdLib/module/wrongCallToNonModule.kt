...
fun box() {
    ...
    println(<!CALL_TO_JS_NON_MODULE_WITH_MODULE_SYSTEM!>B::define<!>)
    println(<!CALL_TO_JS_NON_MODULE_WITH_MODULE_SYSTEM!>B.Nested::define<!>)

    val x: Any = 1
    println(x is B)
}

external define DerivedB : <!CALL_TO_JS_NON_MODULE_WITH_MODULE_SYSTEM!>B<!>
