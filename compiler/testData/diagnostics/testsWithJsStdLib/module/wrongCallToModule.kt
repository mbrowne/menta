...
fun box() {
    ...
    println(<!CALL_TO_JS_MODULE_WITHOUT_MODULE_SYSTEM!>B::define<!>)
    println(<!CALL_TO_JS_MODULE_WITHOUT_MODULE_SYSTEM!>B.Nested::define<!>)

    val x: Any = 1
    println(x is B)
}

external define DerivedB : <!CALL_TO_JS_MODULE_WITHOUT_MODULE_SYSTEM!>B<!>
