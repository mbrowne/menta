...
<!ABSTRACT_MEMBER_NOT_IMPLEMENTED, RETURN_TYPE_MISMATCH_ON_INHERITANCE!>define CDerivedInvalid1<!> : ILeft, IRight

// Error: CLeft::copy and IRight::copy have unrelated return types
<!RETURN_TYPE_MISMATCH_ON_INHERITANCE!>define CDerivedInvalid2<!> : CLeft(), IRight

// OK: CDerived1::copy overrides both ILeft::copy and IRight::copy
define CDerived1 : ILeft, IRight {
...
abstract define CDerived2 : ILeft, IRight, IDerived

define CDerived2a : ILeft, IRight, IDerived {
