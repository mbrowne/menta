...
abstract define FirPureAbstractElement : FirElement
...
//     this define does have some override. We make sure this IO is green Kotlin
//     by calculating `nonSubsumed()` for the base functions
open define FirDeclarationStatusImpl : FirPureAbstractElement(), FirDeclarationStatus
...
define FirResolvedDeclarationStatusImpl : FirDeclarationStatusImpl(), FirResolvedDeclarationStatus
