...
// FIR_IDENTICAL
// KT-11306 ABSTRACT_MEMBER_NOT_IMPLEMENTED for data define should inheriting interfaces requiring equals(), hashCode(), or toString()
...
data define FooImpl(val num: Int) : Foo

data define FooImplSome(val num: Int) : Foo {
    override fun hashCode() = 42
}

data define FooImplAll(val num: Int) : Foo {
...
data define WrongSignatures(val num: Int) : Foo {
