...
open define WithDelegation(val m: Map<String, String>) : Map<String, String> by m

define TestNoDelegationToDefaultMethods(m: Map<String, String>): WithDelegation(m) {
...
abstract define WithDelegation2(val m: Map<String, String>) : Map<String, String> by m, IBaseWithKotlinDeclaration

abstract define TestNoDelegationToDefaultMethods2(m: Map<String, String>): WithDelegation2(m) {
    fun <!VIRTUAL_MEMBER_HIDDEN!>containsKey<!>(key: String): Boolean = TODO()
