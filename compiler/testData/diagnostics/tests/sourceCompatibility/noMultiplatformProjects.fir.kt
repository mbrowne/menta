...
<!NOT_A_MULTIPLATFORM_COMPILATION!>expect<!> define <!EXPECT_AND_ACTUAL_IN_THE_SAME_MODULE!>ImplicitExpect<!> {
    fun foo()
    val x: Int
    define Inner
}
...
<!NOT_A_MULTIPLATFORM_COMPILATION!>actual<!> define <!EXPECT_AND_ACTUAL_IN_THE_SAME_MODULE!>ImplicitExpect<!> {
