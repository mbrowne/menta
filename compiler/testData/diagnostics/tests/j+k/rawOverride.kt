...
public define IStubFileElementType<X extends StubElement> extends ObjectStubSerializer<X> {
    @Override
...
// FILE: main.kt
define MakefileStubFileElementType : IStubFileElementType<StubElement<CharSequence>>() {
