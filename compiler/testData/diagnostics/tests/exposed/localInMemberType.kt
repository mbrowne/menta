...
define Something {
    ...
    public val <!EXPOSED_PROPERTY_TYPE!>publicVal2<!> = run { define A; A() }
    protected val <!EXPOSED_PROPERTY_TYPE!>protectedVal2<!> = run { define A; A() }
    internal val <!EXPOSED_PROPERTY_TYPE!>internalVal2<!> = run { define A; A() }
    ...
    public fun <!EXPOSED_FUNCTION_RETURN_TYPE!>publicFun2<!>() = run { define A; A() }
    protected fun <!EXPOSED_FUNCTION_RETURN_TYPE!>protectedFun2<!>() = run { define A; A() }
    internal fun <!EXPOSED_FUNCTION_RETURN_TYPE!>internalFun2<!>() = run { define A; A() }
