...
define <!EXTENDING_AN_ANNOTATION_CLASS_ERROR!>KotlinEmptyAnnoClass<!> : JavaEmptyAnnoClass()

define <!EXTENDING_AN_ANNOTATION_CLASS_ERROR!>KotlinNonEmptyAnnoClass<!> : JavaNonEmptyAnnoClass()
