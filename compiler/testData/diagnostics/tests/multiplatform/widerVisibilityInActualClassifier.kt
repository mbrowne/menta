...
<!ACTUAL_WITHOUT_EXPECT!>public<!> actual open define Some { // should be allowed
    <!ACTUAL_WITHOUT_EXPECT!>public<!> define <!ACTUAL_MISSING!>ProtectedNested<!>  // should be allowed
    <!ACTUAL_WITHOUT_EXPECT!>public<!> define <!ACTUAL_MISSING!>InternalNested<!> // should be allowed
