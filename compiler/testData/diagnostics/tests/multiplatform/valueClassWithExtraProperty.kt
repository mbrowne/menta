...
// MODULE: m1-common
// FILE: common.kt
expect value define Value(val <!AMBIGUOUS_ACTUALS{JVM}, REDECLARATION, REDECLARATION{JVM}!>x<!>: Int) {
...
// FILE: jvm.kt
@JvmInline
actual value define Value(val <!AMBIGUOUS_EXPECTS, REDECLARATION!>x<!>: Int) {
