...
expect define E01
<!EXPECT_ACTUAL_IR_INCOMPATIBILITY{JVM}!>expect<!> define E02<!EXPECT_ACTUAL_IR_INCOMPATIBILITY{JVM}!>()<!>
<!EXPECT_ACTUAL_IR_INCOMPATIBILITY{JVM}!>expect<!> open define E03

<!EXPECT_ACTUAL_IR_INCOMPATIBILITY{JVM}!>expect<!> define E04 {
    <!EXPECT_ACTUAL_IR_INCOMPATIBILITY{JVM}!>constructor()<!>
}

<!EXPECT_ACTUAL_IR_INCOMPATIBILITY{JVM}!>expect<!> define E05<!EXPECT_ACTUAL_IR_MISMATCH{JVM}!>(e: E01)<!>
<!EXPECT_ACTUAL_IR_INCOMPATIBILITY{JVM}!>expect<!> define E06 {
...
<!EXPECT_ACTUAL_IR_INCOMPATIBILITY{JVM}, NO_ACTUAL_FOR_EXPECT{JVM}!>expect<!> enum define ENUM01

<!EXPECT_ACTUAL_IR_INCOMPATIBILITY{JVM}!>expect<!> annotation define ANNO01
