...
// MODULE: common
expect abstract <!EXPECT_AND_ACTUAL_IN_THE_SAME_MODULE{JVM}!>define Foo<!>() {
    abstract fun foo()
}

<!ABSTRACT_CLASS_MEMBER_NOT_IMPLEMENTED, ABSTRACT_CLASS_MEMBER_NOT_IMPLEMENTED{JVM}!>define Impl<!> : Foo() {}
...
actual abstract <!EXPECT_AND_ACTUAL_IN_THE_SAME_MODULE!>define <!NO_ACTUAL_CLASS_MEMBER_FOR_EXPECTED_CLASS{JVM}!>Foo<!><!> : Base(), I {
