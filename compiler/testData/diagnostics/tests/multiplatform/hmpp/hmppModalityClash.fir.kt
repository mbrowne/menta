...
// MODULE: common
<!EXPECT_ACTUAL_IR_INCOMPATIBILITY{JVM}!>expect<!> abstract define Foo() {
    abstract fun <!EXPECT_ACTUAL_IR_INCOMPATIBILITY{JVM}!>foo<!>()
}

<!ABSTRACT_CLASS_MEMBER_NOT_IMPLEMENTED{METADATA}!>define Impl<!> : Foo() {}
...
actual abstract define <!EXPECT_ACTUAL_INCOMPATIBLE_CLASS_SCOPE!>Foo<!> : Base(), I {
