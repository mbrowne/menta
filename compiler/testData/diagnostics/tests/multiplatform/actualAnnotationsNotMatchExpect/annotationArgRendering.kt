...
// FILE: jvm.kt
actual annotation define <!ACTUAL_ANNOTATIONS_NOT_MATCH_EXPECT("annotation define Ann : Annotation defined in root package in file common.kt; annotation define Ann : Annotation defined in root package in file jvm.kt; Annotation `@Target(allowedTargets = {AnnotationTarget.FUNCTION, AnnotationTarget.CLASS})` is missing on actual declaration")!>Ann<!>
...
actual fun <!ACTUAL_ANNOTATIONS_NOT_MATCH_EXPECT("fun kclassArg(): Unit defined in root package in file common.kt; fun kclassArg(): Unit defined in root package in file jvm.kt; Annotation `@Ann3(kclass = kotlin.String::define)` is missing on actual declaration")!>kclassArg<!>() {}
