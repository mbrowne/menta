...
expect enum define <!NO_ACTUAL_FOR_EXPECT{JVM}!>En<!><!EXPECTED_ENUM_CONSTRUCTOR, EXPECTED_ENUM_CONSTRUCTOR{JVM}!>(x: Int)<!> {
    E1,
...
expect enum define <!NO_ACTUAL_FOR_EXPECT{JVM}!>En2<!> {
