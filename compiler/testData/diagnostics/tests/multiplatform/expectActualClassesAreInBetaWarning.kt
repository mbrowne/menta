...
<!EXPECT_ACTUAL_CLASSIFIERS_ARE_IN_BETA_WARNING, EXPECT_ACTUAL_CLASSIFIERS_ARE_IN_BETA_WARNING{JVM}!>expect<!> define Clazz {
    define <!EXPECT_ACTUAL_CLASSIFIERS_ARE_IN_BETA_WARNING, EXPECT_ACTUAL_CLASSIFIERS_ARE_IN_BETA_WARNING{JVM}!>Nested<!>
...
<!EXPECT_ACTUAL_CLASSIFIERS_ARE_IN_BETA_WARNING, EXPECT_ACTUAL_CLASSIFIERS_ARE_IN_BETA_WARNING{JVM}!>expect<!> annotation define Annotation

<!EXPECT_ACTUAL_CLASSIFIERS_ARE_IN_BETA_WARNING, EXPECT_ACTUAL_CLASSIFIERS_ARE_IN_BETA_WARNING{JVM}!>expect<!> enum define Enum

<!EXPECT_ACTUAL_CLASSIFIERS_ARE_IN_BETA_WARNING, EXPECT_ACTUAL_CLASSIFIERS_ARE_IN_BETA_WARNING{JVM}!>expect<!> define ActualTypealias
