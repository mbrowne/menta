...
<!EXPECT_ACTUAL_IR_INCOMPATIBILITY{JVM}!>expect<!> annotation define A<!EXPECT_ACTUAL_IR_INCOMPATIBILITY{JVM}!>(vararg val x: String)<!>
...
actual annotation define A<!EXPECT_ACTUAL_INCOMPATIBLE_VALUE_PARAMETER_VARARG!>(val <!ACTUAL_MISSING!>x<!>: Array<String>)<!>
