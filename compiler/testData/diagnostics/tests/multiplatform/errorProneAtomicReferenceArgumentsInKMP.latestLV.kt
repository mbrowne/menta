...
fun testTypealiasedJava() {
    ...
    foo.compareAndSet(<!ATOMIC_REF_CALL_ARGUMENT_WITHOUT_CONSISTENT_IDENTITY, ATOMIC_REF_CALL_ARGUMENT_WITHOUT_CONSISTENT_IDENTITY{METADATA}!>bar<!>, <!ATOMIC_REF_CALL_ARGUMENT_WITHOUT_CONSISTENT_IDENTITY, ATOMIC_REF_CALL_ARGUMENT_WITHOUT_CONSISTENT_IDENTITY{METADATA}!>Foo(2u)<!>)
}
