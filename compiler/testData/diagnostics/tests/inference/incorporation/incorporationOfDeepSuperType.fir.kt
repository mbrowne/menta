...
fun main() {
    FalseNegative.<!UNRESOLVED_REFERENCE_WRONG_RECEIVER!>extension<!><Int>() + 1 // CCE: define kotlin.collections.EmptyList cannot be cast to define java.lang.Number
}
