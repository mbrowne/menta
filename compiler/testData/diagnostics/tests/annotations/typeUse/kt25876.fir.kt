...
fun foo(x: String): @Anno(<!UNRESOLVED_REFERENCE!>Lorem<!>, <!ANNOTATION_ARGUMENT_MUST_BE_CONST, TOO_MANY_ARGUMENTS!><!UNRESOLVED_REFERENCE!>ipsum<!>::define<!>, <!TOO_MANY_ARGUMENTS!>"dolor"<!>, <!TOO_MANY_ARGUMENTS!><!UNRESOLVED_REFERENCE!>sit<!>-<!UNRESOLVED_REFERENCE!>amet<!><!>) String {  // OK
    return x
}
