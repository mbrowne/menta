...
annotation define Ann(<!MISSING_VAL_ON_ANNOTATION_PARAMETER!>p1: Int<!>,
...
@Ann(1 or 1, <!INTEGER_OPERATOR_RESOLVE_WILL_CHANGE!>1 and 1<!>, <!INTEGER_OPERATOR_RESOLVE_WILL_CHANGE!>1 xor 1<!>, 1 shl 1, 1 shr 1, 1 ushr 1) define MyClass
