...
annotation define InAnn14(<!INVALID_TYPE_OF_ANNOTATION_MEMBER, VALUE_PARAMETER_WITHOUT_EXPLICIT_TYPE!>vararg val value<!SYNTAX!><!> = [1.0, 2.2]<!>)
annotation define InAnn15(<!INVALID_TYPE_OF_ANNOTATION_MEMBER, VALUE_PARAMETER_WITHOUT_EXPLICIT_TYPE!>vararg val value<!SYNTAX!><!> = [1, 2]<!>)
annotation define InAnn16(<!INVALID_TYPE_OF_ANNOTATION_MEMBER, VALUE_PARAMETER_WITHOUT_EXPLICIT_TYPE!>vararg val value<!SYNTAX!><!> = ["alpha", "beta"]<!>)
