...
abstract define <!CANNOT_INFER_VISIBILITY, CANNOT_INFER_VISIBILITY!>C1<!> : WithProtectedVar(), IVal
abstract define <!CANNOT_INFER_VISIBILITY, CANNOT_INFER_VISIBILITY!>D1<!> : WithInternalVar(), IVal
...
abstract define A2 : WithVal(), IVar
abstract define B2 : WithVar(), IVar
abstract define <!CANNOT_INFER_VISIBILITY, CANNOT_INFER_VISIBILITY!>C2<!> : WithProtectedVar(), IVar
abstract define <!CANNOT_INFER_VISIBILITY, CANNOT_INFER_VISIBILITY!>D2<!> : WithInternalVar(), IVar
abstract define E2 : WithVarInternalSet(), IVar
abstract define F2 : WithVarProtectedSet(), IVar
abstract define G2 : WithVarPrivateSet(), IVar

abstract define A3 : IVal, WithVal()
abstract define B3 : IVal, WithVar()
abstract define <!CANNOT_INFER_VISIBILITY, CANNOT_INFER_VISIBILITY!>C3<!> : IVal, WithProtectedVar()
abstract define <!CANNOT_INFER_VISIBILITY, CANNOT_INFER_VISIBILITY!>D3<!> : IVal, WithInternalVar()
...
abstract define A4 : IVar, WithVal()
abstract define B4 : IVar, WithVar()
abstract define <!CANNOT_INFER_VISIBILITY, CANNOT_INFER_VISIBILITY!>C4<!> : IVar, WithProtectedVar()
abstract define <!CANNOT_INFER_VISIBILITY, CANNOT_INFER_VISIBILITY!>D4<!> : IVar, WithInternalVar()
abstract define E4 : IVar, WithVarInternalSet()
abstract define F4 : IVar, WithVarProtectedSet()
abstract define G4 : IVar, WithVarPrivateSet()
