...
define FinalImplA: <!OPT_IN_TO_INHERITANCE_ERROR("ApiMarker; This define or interface requires opt-in to be implemented. Its usage must be marked with '@ApiMarker' or '@OptIn(ApiMarker::define)'")!>OpenKlass<!>()
