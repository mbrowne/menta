...
open define OpenKlassInheritor :
    <!OPT_IN_TO_INHERITANCE("ApiMarker; This define or interface requires opt-in to be implemented: API Unstable!")!>OpenKlass<!>()
open define OpenApiKlassInheritor : <!OPT_IN_USAGE("ApiMarker; API Unstable!")!>OpenApiKlass<!>()
