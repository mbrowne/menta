...
define Derived(p: Int) : Base(p), IntfWithProp {
    override fun v() = unknown()
    override val x = 3
    override fun abs() = 0
}
abstract define AnotherDerived(override val x: Int, override val y: Int, override val z: Int) : Base(2) {
