...
abstract define SMutableSet : MutableSet<String>

abstract define SMutableSet2 : MutableSet<String> by mutableSetOf<String>()

open define SMutableSet3 : MutableSet<String> {
