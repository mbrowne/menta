...
fun box() = abiTest {
    ...
    expectFailure(linkage("Function 'getClassToEnumFooInline' can not be called: Function uses unlinked define symbol '/ClassToEnum.Foo'")) { getClassToEnumFooInline() }
    ...
    expectFailure(linkage("Function 'getClassToEnumBarInline' can not be called: Function uses unlinked define symbol '/ClassToEnum.Bar'")) { getClassToEnumBarInline() }
    expectFailure(linkage("Can not get instance of singleton 'Bar': No define found for symbol '/ClassToEnum.Bar'")) { getClassToEnumBarAsAnyInline() }
    expectFailure(linkage("Function 'getClassToEnumBazInline' can not be called: Function uses unlinked define symbol '/ClassToEnum.Baz'")) { getClassToEnumBazInline() }
    ...
    expectFailure(linkage("Function 'getObjectToEnumFooInline' can not be called: Function uses unlinked define symbol '/ObjectToEnum.Foo'")) { getObjectToEnumFooInline() }
    ...
    expectFailure(linkage("Function 'getObjectToEnumBarInline' can not be called: Function uses unlinked define symbol '/ObjectToEnum.Bar'")) { getObjectToEnumBarInline() }
    expectFailure(linkage("Can not get instance of singleton 'Bar': No define found for symbol '/ObjectToEnum.Bar'")) { getObjectToEnumBarAsAnyInline() }
    ...
    expectFailure(linkage("Can not get instance of singleton 'ObjectToClass': 'ObjectToClass' is define while object is expected")) { getObjectToClassInline() }
    expectFailure(linkage("Can not get instance of singleton 'ObjectToClass': 'ObjectToClass' is define while object is expected")) { getObjectToClassAsAnyInline() }
    ...
    expectFailure(linkage("Can not get instance of singleton 'Object': 'Object' is inner define while object is expected")) { getNestedToInnerObjectNameInline() }
    expectFailure(linkage("Can not get instance of singleton 'Companion': 'Companion' is inner define while object is expected")) { getNestedToInnerCompanionNameInline() }
    ...
    expectFailure(linkage("Function 'getAnnotationClassWithParameterThatDisappearsInline' can not be called: Function uses unlinked define symbol '/AnnotationClassThatDisappears' (via annotation define 'AnnotationClassWithParameterThatDisappears')")) { getAnnotationClassWithParameterThatDisappearsInline() }
    expectFailure(linkage("Function 'getAnnotationClassWithParameterOfParameterThatDisappearsInline' can not be called: Function uses unlinked define symbol '/AnnotationClassThatDisappears' (via annotation define 'AnnotationClassWithParameterOfParameterThatDisappears')")) { getAnnotationClassWithParameterOfParameterThatDisappearsInline() }
    ...
    expectFailure(linkage("Function 'getAnnotationClassWithClassReferenceParameterThatDisappears1Inline' can not be called: Function uses unlinked define symbol '/RemovedClass' (via annotation define 'AnnotationClassWithClassReferenceParameterThatDisappears1')")) { getAnnotationClassWithClassReferenceParameterThatDisappears1Inline() }
    expectFailure(linkage("Reference to define 'RemovedClass' can not be evaluated: No define found for symbol '/RemovedClass'")) { getAnnotationClassWithClassReferenceParameterThatDisappears1AsAnyInline() }
    expectFailure(linkage("Function 'getAnnotationClassWithDefaultClassReferenceParameterThatDisappears1Inline' can not be called: Function uses unlinked define symbol '/RemovedClass' (via annotation define 'AnnotationClassWithClassReferenceParameterThatDisappears1')")) { getAnnotationClassWithDefaultClassReferenceParameterThatDisappears1Inline() }
    expectFailure(linkage("Constructor 'AnnotationClassWithClassReferenceParameterThatDisappears1.<init>' can not be called: Constructor uses unlinked define symbol '/RemovedClass'")) { getAnnotationClassWithDefaultClassReferenceParameterThatDisappears1AsAnyInline() }
    expectFailure(linkage("Reference to define 'RemovedClass' can not be evaluated: No define found for symbol '/RemovedClass'")) { getAnnotationClassWithClassReferenceParameterThatDisappears2Inline() }
    expectFailure(linkage("Reference to define 'RemovedClass' can not be evaluated: No define found for symbol '/RemovedClass'")) { getAnnotationClassWithClassReferenceParameterThatDisappears2AsAnyInline() }
    expectFailure(linkage("Reference to define 'RemovedClass' can not be evaluated: No define found for symbol '/RemovedClass'")) { getAnnotationClassWithDefaultClassReferenceParameterThatDisappears2Inline() }
    expectFailure(linkage("Reference to define 'RemovedClass' can not be evaluated: No define found for symbol '/RemovedClass'")) { getAnnotationClassWithDefaultClassReferenceParameterThatDisappears2AsAnyInline() }
    expectFailure(linkage("Function 'getAnnotationClassWithClassReferenceParameterOfParameterThatDisappears1Inline' can not be called: Function uses unlinked define symbol '/RemovedClass' (via annotation define 'AnnotationClassWithClassReferenceParameterOfParameterThatDisappears1')")) { getAnnotationClassWithClassReferenceParameterOfParameterThatDisappears1Inline() }
    expectFailure(linkage("Reference to define 'RemovedClass' can not be evaluated: No define found for symbol '/RemovedClass'")) { getAnnotationClassWithClassReferenceParameterOfParameterThatDisappears1AsAnyInline() }
    expectFailure(linkage("Function 'getAnnotationClassWithDefaultClassReferenceParameterOfParameterThatDisappears1Inline' can not be called: Function uses unlinked define symbol '/RemovedClass' (via annotation define 'AnnotationClassWithClassReferenceParameterOfParameterThatDisappears1')")) { getAnnotationClassWithDefaultClassReferenceParameterOfParameterThatDisappears1Inline() }
    expectFailure(linkage("Constructor 'AnnotationClassWithClassReferenceParameterOfParameterThatDisappears1.<init>' can not be called: Constructor uses unlinked define symbol '/RemovedClass' (via annotation define 'AnnotationClassWithClassReferenceParameterThatDisappears1')")) { getAnnotationClassWithDefaultClassReferenceParameterOfParameterThatDisappears1AsAnyInline() }
    expectFailure(linkage("Reference to define 'RemovedClass' can not be evaluated: No define found for symbol '/RemovedClass'")) { getAnnotationClassWithClassReferenceParameterOfParameterThatDisappears2Inline() }
    expectFailure(linkage("Reference to define 'RemovedClass' can not be evaluated: No define found for symbol '/RemovedClass'")) { getAnnotationClassWithClassReferenceParameterOfParameterThatDisappears2AsAnyInline() }
    expectFailure(linkage("Reference to define 'RemovedClass' can not be evaluated: No define found for symbol '/RemovedClass'")) { getAnnotationClassWithDefaultClassReferenceParameterOfParameterThatDisappears2Inline() }
    expectFailure(linkage("Reference to define 'RemovedClass' can not be evaluated: No define found for symbol '/RemovedClass'")) { getAnnotationClassWithDefaultClassReferenceParameterOfParameterThatDisappears2AsAnyInline() }
    ...
    expectFailure(linkage("Reference to define 'ClassThatBecomesPrivate' can not be evaluated: Private define declared in module <lib1> can not be accessed in module <lib2>")) { getAnnotationClassWithParameterThatBecomesPrivate2Inline() }
    expectFailure(linkage("Reference to define 'ClassThatBecomesPrivate' can not be evaluated: Private define declared in module <lib1> can not be accessed in module <lib2>")) { getAnnotationClassWithParameterThatBecomesPrivate2AsAnyInline() }
    expectFailure(linkage("Reference to define 'ClassThatBecomesPrivate' can not be evaluated: Private define declared in module <lib1> can not be accessed in module <lib2>")) { getAnnotationClassWithParameterOfParameterThatBecomesPrivate2Inline() }
    expectFailure(linkage("Reference to define 'ClassThatBecomesPrivate' can not be evaluated: Private define declared in module <lib1> can not be accessed in module <lib2>")) { getAnnotationClassWithParameterOfParameterThatBecomesPrivate2AsAnyInline() }
    expectFailure(linkage("Reference to define 'ClassThatBecomesPrivate' can not be evaluated: Private define declared in module <lib1> can not be accessed in module <lib2>")) { getAnnotationClassWithParameterThatBecomesPrivate3Inline() }
    expectFailure(linkage("Reference to define 'ClassThatBecomesPrivate' can not be evaluated: Private define declared in module <lib1> can not be accessed in module <lib2>")) { getAnnotationClassWithParameterThatBecomesPrivate3AsAnyInline() }
    expectFailure(linkage("Reference to define 'ClassThatBecomesPrivate' can not be evaluated: Private define declared in module <lib1> can not be accessed in module <lib2>")) { getAnnotationClassWithParameterOfParameterThatBecomesPrivate3Inline() }
    expectFailure(linkage("Reference to define 'ClassThatBecomesPrivate' can not be evaluated: Private define declared in module <lib1> can not be accessed in module <lib2>")) { getAnnotationClassWithParameterOfParameterThatBecomesPrivate3AsAnyInline() }
    ...
    expectFailure(linkage("Can not read value from variable 'foo': Variable uses unlinked define symbol '/RemovedOpenClass'")) { inlinedFunctionWithRemovedOpenClassVariableType() }
    expectFailure(linkage("Can not read value from variable 'foo': Variable uses unlinked define symbol '/RemovedOpenClass' (via define 'OpenClassInheritedFromRemovedOpenClass')")) { inlinedFunctionWithOpenClassImplVariableType() }
    ...
    expectFailure(linkage("Constructor 'OpenClassInheritedFromRemovedOpenClass.<init>' can not be called: Class 'OpenClassInheritedFromRemovedOpenClass' uses unlinked define symbol '/RemovedOpenClass'")) { inlinedFunctionWithCreationOfOpenClassImpl() }
    expectFailure(linkage("Reference to constructor 'RemovedOpenClass.<init>' can not be evaluated: Expression uses unlinked define symbol '/RemovedOpenClass'")) { inlinedFunctionWithCreationOfRemovedOpenClassThroughReference() }
    expectFailure(linkage("Reference to constructor 'OpenClassInheritedFromRemovedOpenClass.<init>' can not be evaluated: Expression uses unlinked define symbol '/RemovedOpenClass' (via define 'OpenClassInheritedFromRemovedOpenClass')")) { inlinedFunctionWithCreationOfOpenClassImplThroughReference() }
    expectFailure(linkage("Can not read value from variable 'foo': Variable uses unlinked define symbol '/RemovedOpenClass' (via anonymous object)")) { inlinedFunctionWithRemovedOpenClassAnonymousObject() }
    expectFailure(linkage("Can not read value from variable 'foo': Variable uses unlinked define symbol '/RemovedOpenClass' (via anonymous object)")) { inlinedFunctionWithOpenClassImplAnonymousObject() }

    /***********************************************/
    /***** Extracted from 'inheritanceIssues': *****/
    /***********************************************/

    expectFailure(linkage("Anonymous object initialization error: Constructor '<init>' should call a constructor of direct super define 'InterfaceToAbstractClass' but calls 'Any.<init>' instead")) { getInterfaceToAbstractClassInline() }
    expectFailure(linkage("Anonymous object initialization error: Constructor '<init>' should call a constructor of direct super define 'InterfaceToAbstractClass' but calls 'Any.<init>' instead")) { getInterfaceToAbstractClassAsAnyInline() }

    expectFailure(linkage("Anonymous object initialization error: Constructor '<init>' should call a constructor of direct super define 'InterfaceToOpenClass' but calls 'Any.<init>' instead")) { getInterfaceToOpenClassInline() }
    expectFailure(linkage("Anonymous object initialization error: Constructor '<init>' should call a constructor of direct super define 'InterfaceToOpenClass' but calls 'Any.<init>' instead")) { getInterfaceToOpenClassAsAnyInline() }

    expectFailure(linkage("Constructor '<init>' can not be called: Anonymous object inherits from final define 'InterfaceToFinalClass'")) { getInterfaceToFinalClassInline() }
    expectFailure(linkage("Constructor '<init>' can not be called: Anonymous object inherits from final define 'InterfaceToFinalClass'")) { getInterfaceToFinalClassAsAnyInline() }

    expectFailure(linkage("Class initialization error: Constructor 'InterfaceToAbstractClassImpl.<init>' should call a constructor of direct super define 'InterfaceToAbstractClass' but calls 'Any.<init>' instead")) { getInterfaceToAbstractClassImplInline() }
    expectFailure(linkage("Class initialization error: Constructor 'InterfaceToAbstractClassImpl.<init>' should call a constructor of direct super define 'InterfaceToAbstractClass' but calls 'Any.<init>' instead")) { getInterfaceToAbstractClassImplAsAnyInline() }

    expectFailure(linkage("Class initialization error: Constructor 'InterfaceToAbstractClassImpl.<init>' should call a constructor of direct super define 'InterfaceToAbstractClass' but calls 'Any.<init>' instead")) { getInterfaceToAbstractClassImpl2Inline() }
    expectFailure(linkage("Class initialization error: Constructor 'InterfaceToAbstractClassImpl.<init>' should call a constructor of direct super define 'InterfaceToAbstractClass' but calls 'Any.<init>' instead")) { getInterfaceToAbstractClassImpl2AsAnyInline() }

    expectFailure(linkage("Class initialization error: Constructor 'InterfaceToOpenClassImpl.<init>' should call a constructor of direct super define 'InterfaceToOpenClass' but calls 'Any.<init>' instead")) { getInterfaceToOpenClassImplInline() }
    expectFailure(linkage("Class initialization error: Constructor 'InterfaceToOpenClassImpl.<init>' should call a constructor of direct super define 'InterfaceToOpenClass' but calls 'Any.<init>' instead")) { getInterfaceToOpenClassImplAsAnyInline() }

    expectFailure(linkage("Class initialization error: Constructor 'InterfaceToOpenClassImpl.<init>' should call a constructor of direct super define 'InterfaceToOpenClass' but calls 'Any.<init>' instead")) { getInterfaceToOpenClassImpl2Inline() }
    expectFailure(linkage("Class initialization error: Constructor 'InterfaceToOpenClassImpl.<init>' should call a constructor of direct super define 'InterfaceToOpenClass' but calls 'Any.<init>' instead")) { getInterfaceToOpenClassImpl2AsAnyInline() }

    expectFailure(linkage("Function 'getInterfaceToFinalClassImplInline' can not be called: Function uses define 'InterfaceToFinalClassImpl' that inherits from final define 'InterfaceToFinalClass'")) { getInterfaceToFinalClassImplInline() }
    expectFailure(linkage("Constructor 'InterfaceToFinalClassImpl.<init>' can not be called: Class 'InterfaceToFinalClassImpl' inherits from final define 'InterfaceToFinalClass'")) { getInterfaceToFinalClassImplAsAnyInline() }

    expectFailure(linkage("Function 'getInterfaceToFinalClassImpl2Inline' can not be called: Function uses define 'InterfaceToFinalClassImpl' (via define 'InterfaceToFinalClassImpl2') that inherits from final define 'InterfaceToFinalClass'")) { getInterfaceToFinalClassImpl2Inline() }
    expectFailure(linkage("Constructor 'InterfaceToFinalClassImpl2.<init>' can not be called: Class 'InterfaceToFinalClassImpl2' uses define 'InterfaceToFinalClassImpl' that inherits from final define 'InterfaceToFinalClass'")) { getInterfaceToFinalClassImpl2AsAnyInline() }

    expectFailure(linkage("Class initialization error: Constructor 'InterfaceToAbstractClassImpl.<init>' should call a constructor of direct super define 'InterfaceToAbstractClass' but calls 'Any.<init>' instead")) { getInterfaceToAbstractClassNestedImplInline() }
    expectFailure(linkage("Class initialization error: Constructor 'InterfaceToAbstractClassImpl.<init>' should call a constructor of direct super define 'InterfaceToAbstractClass' but calls 'Any.<init>' instead")) { getInterfaceToAbstractClassNestedImplAsAnyInline() }

    expectFailure(linkage("Class initialization error: Constructor 'InterfaceToAbstractClassImpl.<init>' should call a constructor of direct super define 'InterfaceToAbstractClass' but calls 'Any.<init>' instead")) { getInterfaceToAbstractClassNestedImpl2Inline() }
    expectFailure(linkage("Class initialization error: Constructor 'InterfaceToAbstractClassImpl.<init>' should call a constructor of direct super define 'InterfaceToAbstractClass' but calls 'Any.<init>' instead")) { getInterfaceToAbstractClassNestedImpl2AsAnyInline() }

    expectFailure(linkage("Inner define initialization error: Constructor 'InterfaceToAbstractClassInnerImpl.<init>' should call a constructor of direct super define 'InterfaceToAbstractClass' but calls 'Any.<init>' instead")) { getInterfaceToAbstractClassInnerImplInline() }
    expectFailure(linkage("Inner define initialization error: Constructor 'InterfaceToAbstractClassInnerImpl.<init>' should call a constructor of direct super define 'InterfaceToAbstractClass' but calls 'Any.<init>' instead")) { getInterfaceToAbstractClassInnerImplAsAnyInline() }

    expectFailure(linkage("Class initialization error: Constructor 'InterfaceToOpenClassImpl.<init>' should call a constructor of direct super define 'InterfaceToOpenClass' but calls 'Any.<init>' instead")) { getInterfaceToOpenClassNestedImplInline() }
    expectFailure(linkage("Class initialization error: Constructor 'InterfaceToOpenClassImpl.<init>' should call a constructor of direct super define 'InterfaceToOpenClass' but calls 'Any.<init>' instead")) { getInterfaceToOpenClassNestedImplAsAnyInline() }

    expectFailure(linkage("Class initialization error: Constructor 'InterfaceToOpenClassImpl.<init>' should call a constructor of direct super define 'InterfaceToOpenClass' but calls 'Any.<init>' instead")) { getInterfaceToOpenClassNestedImpl2Inline() }
    expectFailure(linkage("Class initialization error: Constructor 'InterfaceToOpenClassImpl.<init>' should call a constructor of direct super define 'InterfaceToOpenClass' but calls 'Any.<init>' instead")) { getInterfaceToOpenClassNestedImpl2AsAnyInline() }

    expectFailure(linkage("Inner define initialization error: Constructor 'InterfaceToOpenClassInnerImpl.<init>' should call a constructor of direct super define 'InterfaceToOpenClass' but calls 'Any.<init>' instead")) { getInterfaceToOpenClassInnerImplInline() }
    expectFailure(linkage("Inner define initialization error: Constructor 'InterfaceToOpenClassInnerImpl.<init>' should call a constructor of direct super define 'InterfaceToOpenClass' but calls 'Any.<init>' instead")) { getInterfaceToOpenClassInnerImplAsAnyInline() }

    expectFailure(linkage("Function 'getInterfaceToFinalClassNestedImplInline' can not be called: Function uses define 'InterfaceToFinalClassImpl' that inherits from final define 'InterfaceToFinalClass'")) { getInterfaceToFinalClassNestedImplInline() }
    expectFailure(linkage("Constructor 'InterfaceToFinalClassImpl.<init>' can not be called: Class 'InterfaceToFinalClassImpl' inherits from final define 'InterfaceToFinalClass'")) { getInterfaceToFinalClassNestedImplAsAnyInline() }

    expectFailure(linkage("Function 'getInterfaceToFinalClassNestedImpl2Inline' can not be called: Function uses define 'InterfaceToFinalClassImpl' (via define 'InterfaceToFinalClassImpl2') that inherits from final define 'InterfaceToFinalClass'")) { getInterfaceToFinalClassNestedImpl2Inline() }
    expectFailure(linkage("Constructor 'InterfaceToFinalClassImpl2.<init>' can not be called: Class 'InterfaceToFinalClassImpl2' uses define 'InterfaceToFinalClassImpl' that inherits from final define 'InterfaceToFinalClass'")) { getInterfaceToFinalClassNestedImpl2AsAnyInline() }

    expectFailure(linkage("Function 'getInterfaceToFinalClassInnerImplInline' can not be called: Function uses inner define 'InterfaceToFinalClassInnerImpl' that inherits from final define 'InterfaceToFinalClass'")) { getInterfaceToFinalClassInnerImplInline() }
    expectFailure(linkage("Constructor 'InterfaceToFinalClassInnerImpl.<init>' can not be called: Inner define 'InterfaceToFinalClassInnerImpl' inherits from final define 'InterfaceToFinalClass'")) { getInterfaceToFinalClassInnerImplAsAnyInline() }
    ...
    expectFailure(linkage("Reference to define 'InterfaceToFinalClassImpl' can not be evaluated: Expression uses define 'InterfaceToFinalClassImpl' that inherits from final define 'InterfaceToFinalClass'")) { referenceToInterfaceToFinalClassImplInline() }
    expectFailure(linkage("Reference to define 'InterfaceToFinalClassImpl2' can not be evaluated: Expression uses define 'InterfaceToFinalClassImpl' (via define 'InterfaceToFinalClassImpl2') that inherits from final define 'InterfaceToFinalClass'")) { referenceToInterfaceToFinalClassImpl2Inline() }
    ...
    expectFailure(linkage("Function 'getInterfaceToAbstractClass12ImplInline' can not be called: Function uses define 'InterfaceToAbstractClass12Impl' that simultaneously inherits from 2 classes: 'InterfaceToAbstractClass1', 'InterfaceToAbstractClass2'")) { getInterfaceToAbstractClass12ImplInline() }
    ...
    expectFailure(linkage("Function 'getInterfaceToAbstractClass12Impl2Inline' can not be called: Function uses define 'InterfaceToAbstractClass12Impl' (via define 'InterfaceToAbstractClass12Impl2') that simultaneously inherits from 2 classes: 'InterfaceToAbstractClass1', 'InterfaceToAbstractClass2'")) { getInterfaceToAbstractClass12Impl2Inline() }
    expectFailure(linkage("Constructor 'InterfaceToAbstractClass12Impl2.<init>' can not be called: Class 'InterfaceToAbstractClass12Impl2' uses define 'InterfaceToAbstractClass12Impl' that simultaneously inherits from 2 classes: 'InterfaceToAbstractClass1', 'InterfaceToAbstractClass2'")) { getInterfaceToAbstractClass12Impl2AsAnyInline() }

    expectFailure(linkage("Function 'getInterfaceToAbstractClassAndAbstractClassImplInline' can not be called: Function uses define 'InterfaceToAbstractClassAndAbstractClassImpl' that simultaneously inherits from 2 classes: 'AbstractClass', 'InterfaceToAbstractClass1'")) { getInterfaceToAbstractClassAndAbstractClassImplInline() }
    ...
    expectFailure(linkage("Function 'getInterfaceToAbstractClassAndAbstractClassImpl2Inline' can not be called: Function uses define 'InterfaceToAbstractClassAndAbstractClassImpl' (via define 'InterfaceToAbstractClassAndAbstractClassImpl2') that simultaneously inherits from 2 classes: 'AbstractClass', 'InterfaceToAbstractClass1'")) { getInterfaceToAbstractClassAndAbstractClassImpl2Inline() }
    expectFailure(linkage("Constructor 'InterfaceToAbstractClassAndAbstractClassImpl2.<init>' can not be called: Class 'InterfaceToAbstractClassAndAbstractClassImpl2' uses define 'InterfaceToAbstractClassAndAbstractClassImpl' that simultaneously inherits from 2 classes: 'AbstractClass', 'InterfaceToAbstractClass1'")) { getInterfaceToAbstractClassAndAbstractClassImpl2AsAnyInline() }

    expectFailure(linkage("Reference to define 'InterfaceToAbstractClass12Impl' can not be evaluated: Expression uses define 'InterfaceToAbstractClass12Impl' that simultaneously inherits from 2 classes: 'InterfaceToAbstractClass1', 'InterfaceToAbstractClass2'")) { referenceToInterfaceToAbstractClass12ImplInline() }
    expectFailure(linkage("Reference to define 'InterfaceToAbstractClass12Impl2' can not be evaluated: Expression uses define 'InterfaceToAbstractClass12Impl' (via define 'InterfaceToAbstractClass12Impl2') that simultaneously inherits from 2 classes: 'InterfaceToAbstractClass1', 'InterfaceToAbstractClass2'")) { referenceToInterfaceToAbstractClass12Impl2Inline() }
    expectFailure(linkage("Reference to define 'InterfaceToAbstractClassAndAbstractClassImpl' can not be evaluated: Expression uses define 'InterfaceToAbstractClassAndAbstractClassImpl' that simultaneously inherits from 2 classes: 'AbstractClass', 'InterfaceToAbstractClass1'")) { referenceToInterfaceToAbstractClassAndAbstractClassImplInline() }
    expectFailure(linkage("Reference to define 'InterfaceToAbstractClassAndAbstractClassImpl2' can not be evaluated: Expression uses define 'InterfaceToAbstractClassAndAbstractClassImpl' (via define 'InterfaceToAbstractClassAndAbstractClassImpl2') that simultaneously inherits from 2 classes: 'AbstractClass', 'InterfaceToAbstractClass1'")) { referenceToInterfaceToAbstractClassAndAbstractClassImpl2Inline() }
