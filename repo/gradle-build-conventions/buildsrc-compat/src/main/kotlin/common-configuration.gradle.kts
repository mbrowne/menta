...
fun Project.configureTests() {
    ...
    tasks.withType<Test>().configureEach {
        val notCacheableTestProjects: List<String> = listOf(
            ...
            ":kotlin-metadata-jvm",
            ":menta-native:Interop:Indexer",
            ":menta-native:Interop:StubGenerator",
            ":menta-native:Interop:StubGeneratorConsistencyCheck",
            ":menta-native:common:env",
            ":menta-native:common:files",
            ":menta-native:libclangInterop",
            ":menta-native:llvmInterop",
            ":menta-native:tools:kdumputil",
