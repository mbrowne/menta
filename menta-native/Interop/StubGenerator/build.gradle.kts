...
dependencies {
    implementation(project(":menta-native:Interop:Indexer"))
    implementation(project(path = ":menta-native:endorsedLibraries:kotlinx.cli", configuration = "jvmRuntimeElements"))
    ...
    testCppRuntime(project(":menta-native:libclangInterop"))
    testCppRuntime(project(":menta-native:Interop:Runtime"))
}
