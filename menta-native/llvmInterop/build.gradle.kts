...
dependencies {
    ...
    cppImplementation(project(":menta-native:llvmDebugInfoC"))
    cppLink(project(":menta-native:llvmDebugInfoC"))
    cppImplementation(project(":menta-native:libllvmext"))
    cppLink(project(":menta-native:libllvmext"))
