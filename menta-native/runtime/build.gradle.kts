...
dependencies {
    runtimeBitcode(project(":menta-native:runtime"))
}
...
val stdlibBuildTask by tasks.registering(KonanCompileTask::class) {
    ...
    val nativeMain by sourceSets.creating {
        srcDir(project(":menta-native:Interop:Runtime").file("src/main/kotlin"))
        srcDir(project(":menta-native:Interop:Runtime").file("src/native/kotlin"))
...
cacheableTargetNames.forEach { targetName ->
    tasks.register("${targetName}StdlibCache", KonanCacheTask::class.java) {
        ...
        dependsOn(":menta-native:${targetName}CrossDistRuntime")
        ...
        // This path is used in `:menta-native:${targetName}StdlibCache`
