...
open class NativeInteropPlugin : Plugin<Project> {
    override fun apply(target: Project) {
        ...
        target.dependencies {
            interopStubGenerator(project(":menta-native:Interop:StubGenerator"))
            interopStubGenerator(project(":menta-native:endorsedLibraries:kotlinx.cli", "jvmRuntimeElements"))
            interopStubGeneratorCppRuntime(project(":menta-native:libclangInterop"))
            interopStubGeneratorCppRuntime(project(":menta-native:Interop:Runtime"))
            "api"(project(":menta-native:Interop:Runtime"))
            "testImplementation"(project(":menta-native:Interop:StubGeneratorConsistencyCheck", "tests-jar"))
        }
