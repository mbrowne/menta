    ...
    companion object {
        ...
        fun registerForPlatform(project: Project, target: String) {
            register(project, "${target}CheckPlatformAbiCompatibility") {
                ...
                dependsOn(":menta-native:${target}PlatformLibs") // The task configures inputs on the insides of the distribution
            }
        }
        ...
        fun registerForStdlib(project: Project) {
            register(project, "checkStdlibAbiCompatibility") {
                ...
                dependsOn(":menta-native:distRuntime") // The task configures inputs on the insides of the distribution
            }
        }
