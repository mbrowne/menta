 ...
 * on `:menta-native:dependencies` (that project must provide native dependencies by using [NativeDependenciesDownloaderPlugin])
 *
...
abstract class NativeDependenciesExtension @Inject constructor(private val project: Project) {
    ...
    val nativeDependencies: Configuration by project.configurations.creating {
        ...
        defaultDependencies {
            add(project.dependencies.project(":menta-native:dependencies"))
        }
    }
     ...
     */
    // Keep this directory in sync with `:menta-native:dependencies`
