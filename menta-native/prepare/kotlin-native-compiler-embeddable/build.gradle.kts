...
dependencies {
    kotlinNativeEmbedded(project(":menta-native:Interop:Runtime"))
    kotlinNativeEmbedded(project(":menta-native:Interop:Indexer"))
    kotlinNativeEmbedded(project(":menta-native:Interop:StubGenerator"))
    kotlinNativeEmbedded(project(":menta-native:backend.native"))
    kotlinNativeEmbedded(project(":menta-native:utilities:cli-runner"))
    kotlinNativeEmbedded(project(":menta-native:klib"))
    kotlinNativeEmbedded(project(":native:cli-native"))
    kotlinNativeEmbedded(project(":menta-native:endorsedLibraries:kotlinx.cli", "jvmRuntimeElements"))

    kotlinNativeSources(project(":menta-native:backend.native"))
    kotlinNativeSources(project(":native:cli-native"))
    kotlinNativeJavadoc(project(":menta-native:backend.native"))
...
projectTests {
    testTask(jUnitMode = JUnitMode.JUnit4) {
        ...
        jvmArgumentProviders.add(objects.newInstance<ProjectTestArgumentProvider>().apply {
            ...
            dependsOn(":menta-native:distRuntime")
        })
    }
}
